...
INSERT INTO smartcitydb.link VALUES
  ...
  (4,380,'N',10,'S',2,1,'robot'), -- 10 -> 2

  (5,10,'E',3,'W',10,1,'robot'), -- 3 -> 10
  (6,10,'W',10,'E',3,1,'robot'), -- 10 -> 3

  (7,10,'W',4,'E',9,1,'robot'), -- 4 -> 9
  (8,10,'E',9,'W',4,1,'robot'), -- 9 -> 4

  (9,380,'N',5,'S',9,1,'robot'), -- 5 -> 9
  (10,380,'S',9,'N',5,1,'robot'), -- 9 -> 5

  (11,10,'W',6,'E',12,1,'robot'), -- 6 -> 12
  (12,10,'E',12,'W',6,1,'robot'), -- 12 -> 6

  (13,150,'E',7,'W',8,1,'robot'), -- 7 -> 8
  (14,150,'W',8,'E',7,1,'robot'), -- 8 -> 7

  (15,360,'N',7,'W',13,1,'robot'), -- 7 -> 13
  (16,360,'W',13,'N',7,1,'robot'), -- 13 -> 7

  (17,80,'S',7,'N',19,1,'robot'), -- 7 -> T1 (19)

  (18,705,'E',8,'W',9,1,'robot'), -- 8 -> 9

  (19,150,'N',8,'S',13,1,'robot'), -- 8 -> 13
  (20,150,'S',13,'N',8,1,'robot'), -- 13 -> 8

  (21,895,'N',9,'E',13,1,'robot'), -- 9 -> 13

  (22,619,'S',10,'W',17,1,'robot'), -- 10 -> 17

  (23,150,'E',11,'W',12,1,'robot'), -- 11 -> 12
  (24,150,'W',12,'E',11,1,'robot'), -- 12 -> 11

  (25,150,'W',11,'E',16,1,'robot'), -- 11 -> 16
  (26,150,'E',16,'W',11,1,'robot'), -- 16 -> 11

  (27,150,'S',11,'N',18,1,'robot'), -- 11 -> 18
  (28,150,'N',18,'S',11,1,'robot'), -- 18 -> 11

  (29,360,'S',12,'E',18,1,'robot'), -- 12 -> 18
  (30,360,'E',18,'S',12,1,'robot'), -- 18 -> 12

  (31,80,'N',12,'S',20,1,'robot'), -- 12 -> T2 (20)

  (32,425,'N',14,'S',8,1,'robot'), -- 14 -> 8

  (33,150,'E',14,'W',15,1,'robot'), -- 14 -> 15
  (34,150,'W',15,'E',14,1,'robot'), -- 15 -> 14

  (35,425,'S',15,'N',11,1,'robot'), -- 15 -> 11

  (36,425,'W',16,'E',10,1,'robot'), -- 16 -> 10

  (37,150,'S',16,'N',17,1,'robot'), -- 16 -> 17
  (38,150,'N',17,'S',16,1,'robot'), -- 17 -> 16

  (39,150,'E',17,'W',18,1,'robot'), -- 17 -> 18
  (40,150,'W',18,'E',17,1,'robot'), -- 18 -> 17
